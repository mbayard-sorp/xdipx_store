...
**Visuals:** docs/design-doctrine.md (v1.4) is the binding visual charter, the pixel twin of the voice charter: §4 imagery archetypes A-D with the coral-soft/plum-soft/paper ground lock, §6 proof & trust components (never fabricate proof), §7 reference bench. The current competitive decision doc is docs/homepage-team/competitor-teardown-2026-07-live.md. Where this summary and the doctrine disagree, the doctrine wins on pixels.
