...
- **Brand visual rules** (v3, these are non-negotiable):
  ...
  - Backgrounds: white paper (`#FFFFFF`), paper-2 (`#FAFAF9`), paper-3 (`#F4F3F1`), or saturated color-block backdrops (coral, plum tints). Dark surfaces use ink (`#1A1418`). Never the old cream backgrounds.
