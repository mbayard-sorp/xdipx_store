...
- Price drift: supplier cost changes in the feed vs the store's `wholesale_cost`/price — margin erosion nobody noticed.
</signals>
...
- Price/margin drift → `pricing-ops` (via the strategist's brief or a targeted suggestion).
