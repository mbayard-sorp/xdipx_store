...
// kbLookup is referenced as a forward ref in tools-by-stage.server.ts
// for DISCOVERY, RESEARCH, PRESENTATION, OBJECTION, and POST_PURCHASE stages.
// This definition is additive — existing QA_TOOL_DEFINITIONS untouched.
// Note: `Anthropic` type is imported at the top of this file already.
