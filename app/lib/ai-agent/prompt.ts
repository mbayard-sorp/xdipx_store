...
- gate=MATTERS: ask what matters most. Use askQuickChoice — the actual options come from MATTERS_OPTS in discovery-gate.server.ts (currently ["Beginner-friendly", "Discreet", "Waterproof", "Hands-free", "Just show me"] when MATTERS_V2_ENABLED is true; legacy set otherwise). Don't search yet UNLESS they pick "Just show me".
