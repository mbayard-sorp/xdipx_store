...
const VIDEO_RATES: Record<string, number> = {
  ...
  // Tombstones: RunPod is retired (ADR-016, deleted 2026-09-23). Historical rows resolve through these; no tier selects them.
  'runpod/wan22':     0.035775, // last default estimate: 0.00053 $/GPU-s x 1.5 fee x 45 render-s per clip-s
  'runpod/wan22-s2v': 0.06519,  // last default estimate: 0.00053 $/GPU-s x 1.5 fee x 82 render-s per clip-s
