...
const FIXTURE_SPECIMENS: DiscoveryProduct[] = [
  { id: 'fixture-1', handle: 'sample-product-one', title: 'Sample product, the considered pick', defaultVariantId: null, price: 68, priceMax: null, compareAtPrice: 96, colorValues: [], sizeValues: [], imageUrl: null, imageAlt: null, category: 'Pleasure', subcategory: 'Vibrators', brand: 'We-Vibe', mood: [], audience: [], matters: [], totalInventory: null, productType: null, productTypeDial: 'vibrator' },
  { id: 'fixture-2', handle: 'sample-product-two', title: 'Sample product, the quiet everyday', defaultVariantId: null, price: 42, priceMax: null, compareAtPrice: null, colorValues: [], sizeValues: [], imageUrl: null, imageAlt: null, category: 'Body', subcategory: 'Lubricants', brand: 'System JO', mood: [], audience: [], matters: [], totalInventory: null, productType: null, productTypeDial: 'lube' },
  { id: 'fixture-3', handle: 'sample-product-three', title: 'Sample product, for two', defaultVariantId: null, price: 120, priceMax: 155, compareAtPrice: null, colorValues: [], sizeValues: [], imageUrl: null, imageAlt: null, category: 'Play', subcategory: 'Couples', brand: null, mood: [], audience: [], matters: [], totalInventory: null, productType: null, productTypeDial: 'couples' },
  { id: 'fixture-4', handle: 'sample-product-four', title: 'Sample product, to wear', defaultVariantId: null, price: 54, priceMax: null, compareAtPrice: 72, colorValues: [], sizeValues: [], imageUrl: null, imageAlt: null, category: 'Wear', subcategory: 'Lingerie', brand: null, mood: [], audience: [], matters: [], totalInventory: null, productType: null, productTypeDial: 'wear' },
]
