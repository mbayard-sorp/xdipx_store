    ...
    <div>
      ...
      <div className="grid gap-4">
        {[
          ...
          { name: 'Daily Deal',           desc: 'Triggered at midnight by deal-activator cron',         status: 'Active' },
          ...
          <div key={flow.name} className="bg-white rounded-xl p-5 shadow-sm flex items-center justify-between">
            <div>
              <p className="font-semibold text-brand-charcoal">{flow.name}</p>
              <p className="text-sm text-brand-charcoal/60 mt-0.5">{flow.desc}</p>
            </div>
