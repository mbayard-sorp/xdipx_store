...
/* Band order, the slot list, and `resolveBandOrder` now live in
   `~/lib/home-band-order` so the category healthcheck can ask the same
   question the renderer answers instead of re-deriving it (#8414). They are
   re-exported here because this module has been their import path since the
   storefront shipped, and every existing importer keeps working. */
export { BAND_NAMES, DEFAULT_BAND_ORDER, resolveBandOrder, type BandName, type HomeSlot }
