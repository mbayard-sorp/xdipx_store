...
import type { SocialLink, SocialPlatform } from '~/types/cms'
...
export function Footer({ socialLinks = [], logoUrl, logoAlt = 'xdipx' }: FooterProps) {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-white/40">
            <p>© {currentYear} XD Inc. All rights reserved.</p>
