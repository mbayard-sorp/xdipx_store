...
interface Slot { n: number; handle: string; cast: string[]; mood: string; prompt: string; scaleIn?: number; extraProduct?: string }
const SLOTS: Slot[] = [
