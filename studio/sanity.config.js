              ...
              .child(
                S.list()
                  ...
                  .items([
                    ...
                    S.documentTypeListItem('seoContentBrief').title('Content Briefs').icon(() => '📰'),
                    S.documentTypeListItem('trendTopicBrief').title('Trend Topic Briefs').icon(() => '📈'),
                  ]),
              ),
              ...
              .child(
                S.list()
                  ...
                  .items([
                    ...
                    S.documentTypeListItem('podcastReviewBrief').title('Podcast Review Briefs').icon(() => '🎙️'),
                    S.divider(),
