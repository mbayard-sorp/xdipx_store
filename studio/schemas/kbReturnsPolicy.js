/**
 * kbReturnsPolicy — singleton-like. Returns policy text surfaced by the
 * kbLookup tool for SMS / IVR / chat. Additive — does not touch existing schema.
 */
export default {
  name: 'kbReturnsPolicy',
  title: 'KB: Returns Policy',
  type: 'document',
  description: 'Returns policy copy used by the SMS / IVR / chat knowledge-base lookup. One authoritative doc — treat as a singleton.',
  fields: [
    {
      name: 'title',
      title: 'Internal title',
      type: 'string',
      initialValue: 'Returns Policy',
    ...
    },
    {
      ...
      description: 'Full returns policy body — rendered in web-chat richer surface and admin preview.',
    },
    {
      name: 'lastReviewedAt',
